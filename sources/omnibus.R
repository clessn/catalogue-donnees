...
# 0.2 - Data ####
Data <- read.csv("_SharedFolder_catalogue-donnees/Data/omnibus/omnibusclessn.csv")
...
Export_omnibusclessn <- Export

write.csv(Export_omnibusclessn, "_SharedFolder_catalogue-donnees/omnibusVarsList.csv")
