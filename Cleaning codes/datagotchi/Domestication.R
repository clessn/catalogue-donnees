...
# CleanData$cons_noMeat <- NA
# CleanData$cons_noMeat[Data$cons_Vege == 0 & Data$cons_Vegan == 0] <- 0  # meat 
# CleanData$cons_noMeat[Data$cons_Vege != 0 | Data$cons_Vegan != 0] <- 1  # no meat 
# #table(D$cons_noMeat)
# 
# ## SMOKING 
...
# CleanData$app_swag_FormelMerged <- NA
# CleanData$app_swag_FormelMerged[Data$app_swag_Chic == 1 | Data$app_swag_Formel == 1] <- 1  # chic/formal 
# CleanData$app_swag_FormelMerged[Data$app_swag_Chic != 1 & Data$app_swag_Formel != 1] <- 0  # 
# #table(D$app_swag_FormelMerged)
# 
# # merge casual and classique 
# CleanData$app_swag_CasualMerged <- NA
# CleanData$app_swag_CasualMerged[Data$app_swag_Casual == 1 | Data$app_swag_Classique == 1] <- 1  # casual/classique
# CleanData$app_swag_CasualMerged[Data$app_swag_Casual != 1 & Data$app_swag_Classique != 1] <- 0  # 
# #table(D$app_swag_CasualMerged)
# 
# ## DRINKS
# # merge all wines (rosé, white, red and champagne) 
# CleanData$cons_WineMerged <- NA
# CleanData$cons_WineMerged[Data$cons_redWineDrink == 1 | Data$cons_whiteWineDrink == 1 | Data$cons_roseDrink == 1 | Data$cons_sparklingDrink == 1] <- 1  # wine person  
# CleanData$cons_WineMerged[Data$cons_redWineDrink != 1 & Data$cons_whiteWineDrink != 1 & Data$cons_roseDrink != 1 & Data$cons_sparklingDrink != 1] <- 0  # 
# #table(D$cons_WineMerged)
# 
# ## COFFE SHOPS 
# # merge all commercial chains 
# CleanData$cons_coffee_chains <- NA 
# CleanData$cons_coffee_chains[Data$cons_coffee_TimH == 1 | Data$cons_coffee_Starbucks == 1 | Data$cons_coffee_SC == 1 | Data$cons_coffee_McDo == 1] <- 1 # chains coffee 
# CleanData$cons_coffee_chains[Data$cons_coffee_TimH != 1 & Data$cons_coffee_Starbucks != 1 & Data$cons_coffee_SC != 1 & Data$cons_coffee_McDo != 1] <- 0 
# #table(D$cons_coffee_chains)
# 
# ## PETS 
# # merge domestic animals 
# CleanData$animal_domesticMerged <- NA 
# CleanData$animal_domesticMerged[Data$animal_domestic == 1 | Data$animal_cat == 1 | Data$animal_catNdog == 1 | Data$animal_catNdog == 1] <- 1 # domestic animals 
# CleanData$animal_domesticMerged[Data$animal_domestic != 1 & Data$animal_cat != 1 & Data$animal_catNdog != 1 & Data$animal_catNdog != 1] <- 0
# #table(D$animal_domesticMerged)
# 
# ## TRANSPORTS
# # merging all city transits (walk, bicyle, public transit)
# CleanData$act_transport_cityMerged <- NA 
# CleanData$act_transport_cityMerged[Data$act_transport_PublicTransportation == 1 | Data$act_transport_Walk == 1 | Data$act_transport_Bicycle == 1] <- 1 # city transports
# CleanData$act_transport_cityMerged[Data$act_transport_PublicTransportation != 1 & Data$act_transport_Walk != 1 & Data$act_transport_Bicycle != 1] <- 0 
# #table(D$act_transport_cityMerged)
# 
# ## VEHICULE 
# # merging luxury and roadster cars 
# CleanData$vehicule_LuxeMerged <- NA 
# CleanData$vehicule_LuxeMerged[Data$vehicule_Cabriolet == 1 | Data$vehicule_luxury == 1] <- 1 # luxury car
# CleanData$vehicule_LuxeMerged[Data$vehicule_Cabriolet != 1 & Data$vehicule_luxury != 1] <- 0
# #table(D$vehicule_LuxeMerged)
# 
# # merging 4x4 and SUV
# CleanData$vehicule_SUVMerged <- NA 
# CleanData$vehicule_SUVMerged[Data$vehicule_4x4 == 1 | Data$vehicule_VUS == 1] <- 1  # suv car 
# CleanData$vehicule_SUVMerged[Data$vehicule_4x4 != 1 & Data$vehicule_VUS != 1] <- 0 
# #table(D$vehicule_SUVMerged)
# 
# ## DWELLING 
# # merge condo, loft, appartement, tour 
# CleanData$ses_dwelling_cityAppMerged <- NA 
# CleanData$ses_dwelling_cityAppMerged[Data$ses_dwelling_app == 1 | Data$ses_dwelling_condo == 1 | Data$ses_dwelling_tour == 1 | Data$ses_dwelling_coop == 1] <- 1 # city transports
# CleanData$ses_dwelling_cityAppMerged[Data$ses_dwelling_app != 1 & Data$ses_dwelling_condo != 1 & Data$ses_dwelling_tour != 1 & Data$ses_dwelling_coop != 1] <- 0 
# #table(D$ses_dwelling_cityAppMerged)
# 
# ## SHOPPING 
# # merge independent shops, department stores and chain stores 
# CleanData$cons_brand_shopMerged <- NA 
# CleanData$cons_brand_shopMerged[Data$cons_brand_MaR == 1 | Data$cons_brand_ChainesB == 1 | Data$cons_brand_BInd == 1] <- 1 # city transports
# CleanData$cons_brand_shopMerged[Data$cons_brand_MaR != 1 & Data$cons_brand_ChainesB != 1 & Data$cons_brand_BInd != 1] <- 0 
# #table(D$cons_brand_shopMerged)
# 
