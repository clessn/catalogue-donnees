...
clean_ces65[raw_ces65=="not much" | raw_ces65=="some"] <- 0
...
clean_ces74[raw_ces74=="not much at all" | raw_ces74=="fairly closely"] <- 0
...
clean_ces79[raw_ces79=="3" | raw_ces79=="2"] <- 0
...
clean_ces84[raw_ces84=="not much at all" | raw_ces84=="fairly closely"] <- 0
...
clean_ces88[raw_ces88=="not at all" | raw_ces88=="fairly closely" | raw_ces88=="not very closely"] <- 0
...
#### 2. clean variable
clean_ces93 <- NA
clean_ces93[raw_ces93=="very interested"] <- 1
clean_ces93[raw_ces93=="not at all" | raw_ces93=="fairly" | raw_ces93=="not very"] <- 0
...
#### 2. clean variable
clean_ces97 <- NA
clean_ces97[raw_ces97=="8" | raw_ces97=="9" | raw_ces97=="10"] <- 1
clean_ces97[raw_ces97=="7" | raw_ces97=="6" | raw_ces97=="5" | raw_ces97=="4" | raw_ces97=="3" |
...
#### 2. clean variable
clean_ces2000 <- NA
clean_ces2000[raw_ces2000=="8" | raw_ces2000=="9" | raw_ces2000=="10"] <- 1
clean_ces2000[raw_ces2000=="7" | raw_ces2000=="6" | raw_ces2000=="5" | raw_ces2000=="4" | raw_ces2000=="3" |
...
#### 2. clean variable
clean_ces2004 <- NA
clean_ces2004[raw_ces2004=="8" | raw_ces2004=="9" | raw_ces2004=="10"] <- 1
clean_ces2004[raw_ces2004=="7" | raw_ces2004=="6" | raw_ces2004=="5" | raw_ces2004=="4" | raw_ces2004=="3" |
...
#### 2. clean variable
clean_ces2006 <- NA
clean_ces2006[raw_ces2006=="8" | raw_ces2006=="9" | raw_ces2006=="10"] <- 1
clean_ces2006[raw_ces2006=="7" | raw_ces2006=="6" | raw_ces2006=="5" | raw_ces2006=="4" | raw_ces2006=="3" |
...
#### 2. clean variable
clean_ces2008 <- NA
clean_ces2008[raw_ces2008=="8" | raw_ces2008=="9" | raw_ces2008=="10"] <- 1
clean_ces2008[raw_ces2008=="7" | raw_ces2008=="6" | raw_ces2008=="5" | raw_ces2008=="4" | raw_ces2008=="3" |
...
#### 2. clean variable
clean_ces2011 <- NA
clean_ces2011[raw_ces2011=="8" | raw_ces2011=="9" | raw_ces2011=="10"] <- 1
clean_ces2011[raw_ces2011=="7" | raw_ces2011=="6" | raw_ces2011=="5" | raw_ces2011=="4" | raw_ces2011=="3" |
...
#### 2. clean variable
clean_ces2015 <- NA
clean_ces2015[raw_ces2015=="8" | raw_ces2015=="9" | raw_ces2015=="10"] <- 1
clean_ces2015[raw_ces2015=="7" | raw_ces2015=="6" | raw_ces2015=="5" | raw_ces2015=="4" | raw_ces2015=="3" |
...
#### 2. clean variable
clean_ces2019 <- NA
clean_ces2019[raw_ces2019=="8" | raw_ces2019=="9" | raw_ces2019=="10"] <- 1
clean_ces2019[raw_ces2019=="7" | raw_ces2019=="6" | raw_ces2019=="5" | raw_ces2019=="4" | raw_ces2019=="3" |
...
#### 2. clean variable
clean_ces2021 <- NA
clean_ces2021[raw_ces2021=="8" | raw_ces2021=="9" | raw_ces2021=="10"] <- 1
clean_ces2021[raw_ces2021=="7" | raw_ces2021=="6" | raw_ces2021=="5" | raw_ces2021=="4" | raw_ces2021=="3" |
...
raw_datgot22 <- c(raw_datgot22.1, raw_datgot22.2)
...
#### 2. clean variable
clean_sondnat22 <- NA
clean_sondnat22[raw_sondnat22=="8" | raw_sondnat22=="9" | raw_sondnat22=="10"] <- 1
clean_sondnat22[raw_sondnat22=="7" | raw_sondnat22=="6" | raw_sondnat22=="5" | raw_sondnat22=="4" | raw_sondnat22=="3" |
