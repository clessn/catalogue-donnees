...
Dans le Google Sheets à la feuille `recherche-souverainete_codebook`,
...
3.  ***SI VOUS NETTOYEZ UNE VARIABLE QUI A DÉJÀ ÉTÉ NETTOYÉE***:
4.  ***SI VOUS NETTOYEZ UNE VARIABLE QUI N'A PAS ENCORE ÉTÉ NETTOYÉE***: allez voir dans **les autres codebooks** comment la nettoyer de façon à être bien fusionnée avec les autres. S'il est impossible de nettoyer
